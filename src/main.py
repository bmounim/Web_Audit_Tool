...
def get_prompts_for_all(country):
    All_prompts = {
        ...
        "Italy" : ["Verifique se o texto menciona 'TrustPilot', 'Google Recensioni' ou 'Altroconsumo'. Responda 'sim' ou 'não'. Se sim, indique onde está no texto, forneça o original em italiano e descreva sua localização na imagem extraída por OCR.",
